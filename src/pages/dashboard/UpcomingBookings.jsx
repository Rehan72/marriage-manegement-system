...
const handleViewAllBookingDetails = (booking) => {
debugger
  navigate(`/dashboard/bookings/${booking.id}`, { state: { booking } })
}
    ...
    <div className="space-y-4">
     ...
     {/* View Details */}
              ...
              {/* <Button size="sm" asChild>
                <Link to={`/dashboard/bookings/${booking.id}` } state={{ booking }}>View Details</Link>
              </Button> */}
      ...
      <div className="text-center">
        <Button variant="ghost"  onClick={handleViewAllBookingDetails}>
        {/* View All Bookings */}
          {/* <Link to="/dashboard/bookings" state={ bookings.id }>View All Bookings</Link> */}
        </Button>
      </div>
    </div>
  )
